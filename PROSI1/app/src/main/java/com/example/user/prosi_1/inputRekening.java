...
//
//        Spinner itemNama = (Spinner) findViewById(R.id.spinner_nama_bank);
//        Spinner itemKota = (Spinner) findViewById(R.id.spinner_kota_bank);
//        itemNama.setAdapter(adapterNama);
//        itemKota.setAdapter(adapterKota);
    }
